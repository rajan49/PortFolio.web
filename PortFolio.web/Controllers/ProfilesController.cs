...
namespace PortFolio.web.Controllers
{
    public class ProfilesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Email,Summary,FullName,DatrOfBiret,Website")] ProfileModel profileModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Email,Summary,FullName,DatrOfBiret,Website")] ProfileModel profileModel)
        {
